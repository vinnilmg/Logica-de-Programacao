	...
	import javax.swing.JOptionPane;
		...
		public class Log15 {
			...
			public static void main(String[] args) {
				...
				case "s": System.out.println("Soma abaixo da diagonal secundária " + " é: " + formato.format(soma)); break;
				case "m": System.out.println("A Média abaixo da diagonal secundária "+ " é: " + formato.format((soma/12)));	
				}
		}					
	}
